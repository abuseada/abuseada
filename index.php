...
<main>
    ...
    <section class="showcase-area" id="home">
        <img src="./assets/stock/square1.png" alt="Shape" class="shape square">
        <div class="container">
            <div class="showcase-info">
                <h3 class="sub-heading">Graphic Designer</h3>
                <h1 class="heading">Ibrahim Abu Seada</h1>
                <p class="text">I am a freelance Graphic Designer. Let's Work Together.</p>
                <div class="cta">
                    <a href="mailto:ibrahimabuseada4@gmail.com" target="_blank" class="btn">Contact Me</a>
                    <a href="/stock/Abu Seada CV.pdf" download class="btn secondary-btn">Download CV</a>
                </div>
            </div>
            <div class="showcase-image">
                <img src="./assets/stock/Abu-Seada-Photo.png" alt="Abu Seada" class="person">
                <img src="./assets/stock/circle1.png" alt="Shape" class="shape circle">
                <img src="./assets/stock/dots.png" alt="Shape" class="shape dots">
            </div>
        </div>
    </section>
    ...
    <section class="about section" id="about">
        <img src="./assets/stock/triangle.png" alt="Shape" class="shape triangle">
        <div class="container">
            ...
            <div class="about-info">
                ...
                <h1 class="heading">Better design, <br> Better Experience.</h1>
                <p class="text">We are an online Advertising and Marketing Office - ready to provide the <br> service you want at the time you want and with distinct ideas .. <br>
                    <span>Our motto is #Your_Success_From_Our_Success.</span></p>
                <div class="cta">
                    <a href="mailto:ibrahimabuseada4@gmail.com" target="_blank" class="btn">Contact Me</a>
                    <a href="/stock/Abu-Seada-CV.pdf" download class="btn secondary-btn">Download CV</a>
                </div>
        ...
        <div class="container">
            <div class="skills-box">
                <div class="box-heading">
                    ...
                    <div class="box-desc">
                        <p class="text">
                            Although I am diverse in various fields (Graphic Design, Accounting, Front End Developer [low level], web design [mid level]), I love graphic design, accounting, and I love developing myself to reach my goal..
                        </p>
                        <a href="#" class="btn">Hire Me</a>
                    </div>
                  </div>
                <div class="skills-warp">
                    <div class="skill">
                        ...
                        <div class="sk-title">Social Media</div>
                    </div>
                    <div class="skill">
                        <div class="sk-progress">
                            <svg>
                        ...
                        <div class="sk-title">Logo Design</div>
                    </div>
                    <div class="skill">
                        <div class="sk-progress">
                            <svg>
                    ...
                    <div class="skill">
                        ...
                        <div class="sk-title">Facebook ADs</div>
                    </div>
                </div>
                <img src="./assets/stock/dots.png" alt="Shape" class="shape dots">
                <img src="./assets/stock/square1.png" alt="Shape" class="shape square">
    ...
    <section class="services section" id="services">
        ...
        <div class="container">
            <div class="services-info">
                ...
                <p class="text">From offering in -depth user research, to helping with design and testing, I can help bring your product to life.</p>
                <div class="milestones">
                    <div class="ml">
                        <h2 class="number"><span data-target="4">0</span>+</h2>
                        <h5>Years</h5>
                    </div>
                    <div class="ml">
                        <h2 class="number"><span data-target="10">0</span>+</h2>
                        <h5>Projects</h5>
                    </div>
                    <div class="ml">
                        <h2 class="number"><span data-target="25">0</span>+</h2>
                        <h5>Clients</h5>
                    </div>
                </div>
                <div class="cta">
                    <a href="mailto:info@abuseada.net" target="_blank" class="btn">Contact Me</a>
                    <a href="/stock/Abu Seada CV.pdf" download class="btn secondary-btn">Download CV</a>
                </div>
            </div>
            <div class="services-grid">
                <div class="srv-card">
                    <div class="card-desc">
                        ...
                        <p class="text">
                          You can find solutions to your graphic design needs immediately or if you need continuous designs, you can get information about our monthly graphic design services.
                        </p>
                    </div>
                    <a href="social-media-design" class="btn secondary-btn">Explore More</a>
                </div>
                <div class="srv-card">
                    <div class="card-desc">
                        <h3>Logo Design</h3>
                        <p class="text">
                          A logo prepared with the right theoretical rules expresses your brand in the best way without forcing you in any environment and material.
                        </p>
                    </div>
                    <a href="logo-design" class="btn secondary-btn">Explore More</a>
                </div>
                <div class="srv-card">
                    <div class="card-desc">
                        <h3>Web Design</h3>
                        <p class="text">
                          Design tools: AdobeXD. Development tools: Html, Css Vue.js, and Jquery. Ask for references and more details.
                        </p>
                    </div>
                    <a href="web-design" class="btn secondary-btn">Explore More</a>
                </div>
                <div class="srv-card">
                    <div class="card-desc">
                        <h3>Printing Design</h3>
                        <p class="text">
                          Creative flyer and brochure designs promoting your products and services.
                        </p>
                    </div>
                    <a href="printing-design" class="btn secondary-btn">Explore More</a>
                </div>
                <img src="./assets/stock/square1.png" alt="Shape" class="shape square">
            </div>
        </div>
    ...
    <section class="portfolio section" id="portfolio">
      <div class="model">
        ...
        <div class="slider-wrap">
          ...
          <div class="images">
            <img class="showImage" src="./assets/stock/porfolio_img/Logo-Folio.png" alt="DZ Logo">
            <img src="./assets/stock/porfolio_img/AX-Thumbnial.png" alt="AX Thumbnial">
            <img src="./assets/stock/porfolio_img/Abu Seada WebSite.jpg" alt="Abu Seada Website">
            <img src="./assets/stock/porfolio_img/Horus-Logo-Design.png" alt="Horus Logo">
            <img src="./assets/stock/porfolio_img/Social-Media-Design.png" alt="Social Media Design">
            <img src="./assets/stock/porfolio_img/Curvilt-WebSite.png" alt="Curvilt Web Site">
          </div>
        ...
        <div class="container">
            <div class="portfolio-header">
                ...
                <div class="filter btns">
                    ...
                    <button class="filter-btn" data-filter=".social-media">Socil Media</button>
                    <button class="filter-btn" data-filter=".logo-design">Logo</button>
            ...
            <div class="portfolio-gallery">
                <div class="mix prt-card logo-design">
                    <div class="prt-image">
                        <img src="./assets/stock/porfolio_img/Logo-Folio.png" alt="Logo Folio Project">
                        <div class="prt-overlay">
                          <span class="prt-icon zoom-icon" style="--i: 0s">
                            <i class="uil uil-search-plus"></i>
                          </span>
                          <a href="https://www.behance.net/gallery/105268543/DZ-Designers-Zone-Logo-Design" target="_blank" class="prt-icon" style="--i: 0.15s">
                            <i class="uil uil-link-h"></i>
                          </a>
                        </div>
                    </div>
                    <div class="prt-desc">
                        <h3>Logo Folio Project</h3>
                        <a href="https://www.behance.net/gallery/147400725/Logo-Folio-V1-Abu-Seada?fbclid=IwAR2I9jb43sOz5tzsNcmUm4lnfPhywanNJ41KPJz_oN7XWHhk6n7ZOtPqJC0" target="_blank" class="btn secondary-btn sm">View Project</a>
                    </div>
                </div>
                <div class="mix prt-card social-media">
                    <div class="prt-image">
                        <img src="./assets/stock/porfolio_img/AX-Thumbnial.png" class="zoom-icon" alt="AX Thumbnial">
                        <div class="prt-overlay">
                          <span class="prt-icon zoom-icon" style="--i: 0s">
                            <i class="uil uil-search-plus"></i>
                          </span>
                          <a href="https://www.behance.net/gallery/102358789/AkainuX-YouTube-Channel-Graphics" target="_blank" class="prt-icon" style="--i: 0.15s">
                            <i class="uil uil-link-h"></i>
                          </a>
                        </div>
                    </div>
                    <div class="prt-desc">
                        <h3>AkainuX YouTube</h3>
                        <a href="https://www.behance.net/gallery/102358789/AkainuX-YouTube-Channel-Graphics target="_blank"" class="btn secondary-btn sm">View Project</a>
                    </div>
                </div>
                <div class="mix prt-card web-design">
                    <div class="prt-image">
                        <img src="./assets/stock/porfolio_img/Abu Seada WebSite.jpg" class="zoom-icon" alt="Abu Seada Website">
                        <div class="prt-overlay">
                          <span class="prt-icon zoom-icon" style="--i: 0s">
                            <i class="uil uil-search-plus"></i>
                          </span>
                          <a href="https://www.behance.net/gallery/118384039/Abu-Seada-Web-Site-UIUX?tracking_source=project_owner_other_projects" target="_blank" class="prt-icon" style="--i: 0.15s">
                            <i class="uil uil-link-h"></i>
                          </a>
                        </div>
                    </div>
                    <div class="prt-desc">
                        <h3>Abu Seada Web Design</h3>
                        <a href="https://www.behance.net/gallery/118384039/Abu-Seada-Web-Site-UIUX?tracking_source=project_owner_other_projects" target="_blank" class="btn secondary-btn sm">View Project</a>
                    </div>
                </div>
                <div class="mix prt-card logo-design">
                    <div class="prt-image">
                        <img src="./assets/stock/porfolio_img/Horus-Logo-Design.png" class="zoom-icon" alt="Horus Logo">
                        <div class="prt-overlay">
                          <span class="prt-icon zoom-icon" style="--i: 0s">
                            <i class="uil uil-search-plus"></i>
                          </span>
                          <a href="https://www.behance.net/gallery/100158895/Horus-?tracking_source=project_owner_other_projects" target="_blank" class="prt-icon" style="--i: 0.15s">
                            <i class="uil uil-link-h"></i>
                          </a>
                        </div>
                    </div>
                    <div class="prt-desc">
                        <h3>Horus - حورس</h3>
                        <a href="https://www.behance.net/gallery/100158895/Horus-?tracking_source=project_owner_other_projects" target="_blank" class="btn secondary-btn sm">View Project</a>
                    </div>
                </div>
                <div class="mix prt-card social-media">
                    <div class="prt-image">
                        <img src="./assets/stock/porfolio_img/Social-Media-Design.png" class="zoom-icon" alt="Social Media Design">
                        <div class="prt-overlay">
                          <span class="prt-icon zoom-icon" style="--i: 0s">
                            <i class="uil uil-search-plus"></i>
                          </span>
                          <a href="https://www.behance.net/gallery/91226985/Social-Media-Designs?tracking_source=project_owner_other_projects" target="_blank" class="prt-icon" style="--i: 0.15s">
                            <i class="uil uil-link-h"></i>
                          </a>
                        </div>
                    </div>
                    <div class="prt-desc">
                        ...
                        <a href="https://www.behance.net/gallery/91226985/Social-Media-Designs?tracking_source=project_owner_other_projects" target="_blank" class="btn secondary-btn sm">View Project</a>
                    </div>
                </div>
                <div class="mix prt-card web-design">
                    <div class="prt-image">
                        ...
                        <div class="prt-overlay">
                          ...
                          <a href="https://www.behance.net/gallery/118789935/Curvilt-Website-UI" target="_blank" class="prt-icon" style="--i: 0.15s">
                            <i class="uil uil-link-h"></i>
                          </a>
                        </div>
                    </div>
                    <div class="prt-desc">
                        <h3>Curvilt Website</h3>
                        <a href="https://www.behance.net/gallery/118789935/Curvilt-Website-UI" target="_blank" class="btn secondary-btn sm">View Project</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="contact section" id="contact">
        <img src="./assets/stock/triangle.png" alt="Shape" class="shape triangle">
        <div class="container">
            <img src="./assets/stock/square2.png" alt="Shape" class="shape square">
            <div class="contact-info">
                <h3 class="sub-heading">Contact me</h3>
                <h1 class="heading">Let's Work Together</h1>
                <p class="text">
                    Ask Me. I here to help! <br>
                    I will send you an e-mail to confirm your request!
                </p>
                <a href="mailto:info@abuseada.net" class="mail">Send E-Mail: info@abuseada.net <i class="uil uil-arrow-right"></i></a>
                <br>
                <a href="tel:+201065043842" class="phone">Call: (+20) 1065043842 <i class="uil uil-arrow-right"></i></a>
                <br>
                <a href="https://wa.me/message/MNSCN6SK2J25K1 " class="whats-app">What's App: (+20) 1065043842 <i class="uil uil-arrow-right"></i></a>
            </div>
            <form class="contact-form" method="POST" role="form">
                <h3>Send me a message</h3>
                <input type="text" name="name" class="form-input" id="name" placeholder="Your Name" required>
                <input type="email" name="email" class="form-input" id="email" placeholder="Your E-Mail" required>
                <input type="text" name="phone" class="form-input" id="phone" placeholder="Your What's App Number" required>
                <textarea name="massege" placeholder="Project Details" class="form-input" id="message" required></textarea>
    ...
    <!-- <section class="subscription section">
        <div class="container">
            <img src="./assets/stock/map.png" alt="shape" class="shape map">
            <div class="sub-box">
                <img src="./assets/stock/square2.png" alt="Shape" class="shape square">
                <div class="sub-info">
                    <h3 class="sub-heading">News letter</h3>
                    <h1 class="heading">Get news about my projects</h1>
                    <p class="text">
                        StayUp to date to know what's new
                    </p>
                </div>
                <form method="POST" role="form">
                    <input type="mail" name="mail" class="form-input" id="email-sub" placeholder="E-Mail" required>
                    <input type="submit" name="ok" value="Send" class="btn">
                </form>
            </div>
        </div>
...
<!-- ===================== What's App Chat Icon ===================== -->
<div class="whats_app">
    <div class="chatBox" id="chatBox">
        <div class="chatHeader">
            <div class="chatImg">
                <img src="./assets/stock/chat-profile.png" alt="Abu Seada Profile Img">
            </div>
            <div class="chatTitle">
                <h3 class="chatName">Abu Seada</h3>
                <p class="jobTitle">Graphic Designer</p>
            </div>
            <div class="chatCall">
                <a href="tel:+201065043842"><i class="uil uil-phone"></i></a>
            </div>
        </div>
        <div class="chatBody">
            <div class="chatIcon">A</div>
            <div class="msg">
                <p class="text">Hi, Thair I'm Online To Chat. <br> Start Now.</p>
            </div>
        </div>
        <div class="chatBtns">
            <a href="https://wa.me/message/MNSCN6SK2J25K1" target="_blank" class="btn wts"><i class="uil uil-whatsapp"></i> What's App</a>
            <a href="https://m.me/abuseada.net" target="_blank" class="btn msgr"><i class="uil uil-facebook-messenger-alt"></i> Facebook</a>
        </div>
    </div>
    <button  class="openChat" id="openChat">
        <i class="uil uil-comment-dots"></i> Start Chat Now
    </button>
</div>
